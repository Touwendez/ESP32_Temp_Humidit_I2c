/**********************************************************************
  Ce code qest un croquis Arduino 
  qui utilise un affichage LCD avec un module I2C et un capteur 
  de température et d'humidité DHT11. Il utilise les bibliothèques
   Wire.h, LiquidCrystal_I2C.h et DHTesp.h.
**********************************************************************/
#include <Wire.h>
